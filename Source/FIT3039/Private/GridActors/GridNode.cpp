...
void UGridNode::InitNode(AGridMap* InGridMap, FVector InLocation, FGridVector InCoordinate, float InSize, EOccupantType InOccupantType)
{
	GridMap = InGridMap;
	Location = InLocation;
...
void UGridNode::SetOccupyingPlant(ACrop* Incrop)
{
	OccupyCrop = Incrop;
}
...
ACrop* UGridNode::GetOccupyingPlant() const
{
	return OccupyCrop;
}
