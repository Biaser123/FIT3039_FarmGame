...
public:
	...
	virtual void InitNode(AGridMap* InGridMap, FVector InLocation, FGridVector InCoordinate, float InSize, EOccupantType InOccupantType);
	...
	class ACrop* OccupyCrop;

	//setter getter for crop
	
	ACrop* GetOccupyingPlant() const;
	
	void SetOccupyingPlant(class ACrop* Incrop);
